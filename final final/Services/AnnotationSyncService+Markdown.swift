...
extension AnnotationSyncService {
    ...
    func replaceAnnotationText(
        ...
        DebugLog.log(.editor, "[AnnotationSyncService] Warning: No annotation found near offset \(oldCharOffset) for replacement")
        return AnnotationReplaceResult(markdown: markdown, newCharOffset: oldCharOffset)
    }
    ...
    func updateTaskCompletion(in markdown: String, at offset: Int, isCompleted: Bool) -> String {
        ...
        DebugLog.log(.editor, "[AnnotationSyncService] Warning: No task annotation found near offset \(offset)")
        return markdown
    }
}
