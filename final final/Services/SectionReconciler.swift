...
struct SectionReconciler: Sendable {
    ...
    func reconcile(
        ...
        var changes = changesForHeaders(
            headers,
            sortedDB: sortedDB,
            projectId: projectId,
            matchedDBIds: &matchedDBIds
        )
        ...
        changes += deleteSweepChanges(
            sortedDB: sortedDB,
            matchedDBIds: matchedDBIds,
            flaggedRows: DeleteSweepFlagState(
                bibliographyGone: survival.bibliographyGone,
                notesGone: survival.notesGone,
    ...
    // MARK: - Private Delete-Sweep Support
    ...
    func mergeSurvivorUpdates(loser: Section, survivor: Section) -> SectionUpdates {
