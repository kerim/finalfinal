...
The vite configurations in git have ALWAYS been broken since Phase 1.3. The working IIFE build setup was developed but NEVER committed - it only existed as uncommitted changes that got stashed.
